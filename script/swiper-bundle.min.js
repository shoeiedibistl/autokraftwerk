...
const worksImgSwiper = new Swiper('[data-slider="works-img"]', {
  loop: true,
  slidesPerView: 1,
  spaceBetween: 60,
  autoHeight: true,
  ...
  navigation: {
    nextEl: ".works-slider__button.right",
    prevEl: ".works-slider__button.left",
  },
});

const worksTitleSwiper = new Swiper('[data-slider="works-title"]', {
  loop: true,
  slidesPerView: 1,
  autoHeight: true,
  allowTouchMove: false,
...
const worksDescSwiper = new Swiper('[data-slider="works-desc"]', {
  loop: true,
  slidesPerView: 1,
  autoHeight: true,
  allowTouchMove: false,
...
worksImgSwiper.on("slideChange", function () {
  const slides = [...worksImgSwiper.el.querySelectorAll(".swiper-slide")];
  ...
  setTimeout(() => {
    ...
    console.log("swiper active slide = " + activeIndex);

    worksTitleSwiper.slideToLoop(activeIndex);

    worksDescSwiper.slideToLoop(activeIndex);
  }, 0);
});
